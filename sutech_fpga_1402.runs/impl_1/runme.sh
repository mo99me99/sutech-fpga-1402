...
HD_PWD='G:/SUTECH/Digital/project/sutech_fpga_1402/sutech_fpga_1402.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log WATERING.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source WATERING.tcl -notrace
