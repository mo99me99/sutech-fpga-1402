...
HD_PWD='G:/SUTECH/Digital/project/sutech_fpga_1402/sutech_fpga_1402.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WATERING.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WATERING.tcl
